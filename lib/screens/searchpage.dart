...
import 'package:taxigo_user_app/datamodels/prediction.dart';
import 'package:taxigo_user_app/dataprovider/appdata.dart';
import 'package:taxigo_user_app/globalvariable.dart';
import 'package:taxigo_user_app/helpers/requesthelper.dart';
import 'package:taxigo_user_app/widgets/BrandDivier.dart';
import 'package:taxigo_user_app/widgets/PredictionTile.dart';
                ...
                children: <Widget>[
                  ...
                  Stack(
                    children: <Widget>[
                      ...
                      Center(
                        child: Text(Translations.of(context).text('set_destination'),
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: Translations.of(context).text('location'),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  hintText: Translations.of(context).text('where'),
                                  fillColor: BrandColors.colorLightGrayFair,
                                  filled: true,
                                  border: InputBorder.none,
                                  isDense: true,
